...
var myIcon = L.icon({
    iconUrl: './asset/image/epingle.png',
    iconSize: [48, 65],
    iconAnchor: [32, 64],
});

var myIconDeux = L.icon({
    iconUrl: './asset/image/om.png',
    iconSize: [68, 65],
    iconAnchor: [52, 64],
});

var myIconTrois = L.icon({
    iconUrl: './asset/image/logo-TFC.png',
    iconSize: [68, 65],
    iconAnchor: [52, 64],
});

var myIconQuatre = L.icon({
    iconUrl: './asset/image/clermont.png',
    iconSize: [68, 65],
    iconAnchor: [52, 64],
});


var myIconCinq = L.icon({
    iconUrl: './asset/image/grenoble.png',
    iconSize: [68, 65],
    iconAnchor: [52, 64],
});

var myIconSix = L.icon({
    iconUrl: './asset/image/bordeaux.png',
    iconSize: [68, 65],
    iconAnchor: [52, 64],
});
...
var markerAvignon = L.marker([43.9420677, 4.8072416], {icon: myIcon}).addTo(map);
var popupContentAndrea = '<h2>Andréa Lopez</h2><b>Avignon</b><p> Techs : JS, PHP, CSS, HTML <br> Hobbies: Drama coréen, Jeux video</p><img src="./asset/image/andrea.jpg" alt="smain" width="200px"/><br><a href="https://www.linkedin.com/in/andrealpz/">Linkedin</a><br><a href="#">Github</a>';
markerAvignon.bindPopup(popupContentAndrea).openPopup();

var markerAigueperse = L.marker([46.0167, 3.2], {icon: myIcon}).addTo(map);
...
var markerToulouse = L.marker([43.600000, 1.433333], {icon: myIconTrois}).addTo(map);
...
var markerMarseille = L.marker([43.300000, 5.400000], {icon: myIconDeux}).addTo(map);
...
var markerBordeaux = L.marker([44.833328, -0.56667], {icon: myIconSix}).addTo(map);
var popupContentMedhi = '<h2>Medhi Rezgane</h2><b>Bordeaux</b><p> Techs : Php, symphony, html, sass, js, jquery, react <br> Hobbies: Foot, Madrid</p><img src="./asset/image/medhi.jpg" alt="smain" width="200px" /><br><a href="https://www.linkedin.com/in/mehdi-rezgane/">Linkedin</a><br><a href="https://github.com/FlexCodeur">Github</a>';
markerBordeaux.bindPopup(popupContentMedhi).openPopup();

var markerAix = L.marker([43.529742, 5.447427], {icon: myIcon}).addTo(map);
...
var markerClermont = L.marker([45.777222, 3.087025], {icon: myIconQuatre}).addTo(map);
var popupContentArnaud = '<h2>Arnaud Fenérol</h2><b>Clermont Ferrant</b><p> Techs : Js, React <br> Hobbies: Jeux video cinéma</p><img src="./asset/image/arnaud.jpg" alt="smain" width="200px" /><br><a href="https://www.linkedin.com/in/afenerol">Linkedin</a><br><a href="https://github.com/arnaudfl">Github</a>';
markerClermont.bindPopup(popupContentArnaud).openPopup();

var markerTours = L.marker([47.383333, 0.683333], {icon: myIcon}).addTo(map);
...
var markerThiers = L.marker([45.857907, 3.545177], {icon: myIcon}).addTo(map);
var popupContentSmain = '<h2>Smain Kaya</h2><p> Techs : Laravel, Js, Tailwind <br> Hobbies: Foot, Littérature(manga)</p><img src="./asset/image/smain.jpg" alt="smain" width="200px" /><br><a href="#">Linkedin</a><br><a href="https://github.com/KAYA-SMAIN">Github</a>';
markerThiers.bindPopup(popupContentSmain).openPopup();

var markerGrenoble = L.marker([45.166672, 5.71667], {icon: myIconCinq}).addTo(map);
var popupContentLucas = '<h2>Lucas Bosak</h2><p> Techs : React <br> Hobbies: Orga d’event</p><img src="./asset/image/lucas.jpg" alt="smain" width="200px" /><br><a href="https://www.linkedin.com/in/lucas-bosak/">Linkedin</a><br><a href="https://github.com/Kalsak15">Github</a>';
